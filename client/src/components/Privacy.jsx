...
const Privacy = () => {
  return (
    <Container>
      ...
      <p>
        Xzymous (&quot;us&quot;, &quot;we&quot;, or &quot;our&quot;) operates the
        https://www.arnelimperial.com website (hereinafter referred to as the &quot;Service&quot;).
      </p>

      <p>
        This page informs you of our policies regarding the collection, use, and disclosure of
        personal data when you use our Service and the choices you have associated with that data.
        The Privacy Policy for Xzymous has been created with the help of{' '}
      ...
      <p>
        ...
        our Terms and Conditions, accessible from https://www.arnelimperial.com
      </p>
      ...
      <ul>
        <li>
          ...
          <p>Service is the https://www.arnelimperial.com website operated by Xzymous</p>
        </li>
        <li>
          <p>
      ...
      <p>
        ...
        information, passwords, and social media login data.
      </p>
      <p>
      ...
      <p>
        We provide you with the option to register using social media account details, like your
        Facebook, Twitter or other social media account. If you choose to register in this way, we
        will collect the Information described in the section called &quot;HANDLING SOCIAL MEDIA
        LOGINS&quot; below.
      </p>
      ...
      <p>
        Xzymous will take all steps reasonably necessary to ensure that your data is treated
      ...
      <p>
        Xzymous may disclose your Personal Data in the good faith belief that such action is
        necessary to:
      </p>
      <ul>
      ...
      <p>
        As an European citizen, under GDPR, you have certain individual rights. You can learn more
        about these guides in the{' '}
        <a href="https://termsfeed.com/blog/gdpr/#Individual_Rights_Under_the_GDPR">GDPR Guide</a>.
      </p>
      ...
      <p>
        Our Services offer you the ability to register and login using your third party social media
      ...
      <h2>Contact Us</h2>
      <p>If you have any questions about this Privacy Policy, please contact the coder.</p>
      <ul>
