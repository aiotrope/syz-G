...
var fbLogin = function fbLogin(passport) {
  passport.use(new _passportFacebook.Strategy(options, /*#__PURE__*/function () {
    var _ref = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(req, accessToken, refreshToken, profile, cb) {
...
_passport.default.deserializeUser( /*#__PURE__*/function () {
  var _ref2 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2(id, cb) {
    var user;
