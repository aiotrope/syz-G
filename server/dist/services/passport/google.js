...
var googleLogin = function googleLogin(passport) {
  passport.use(new _passportGoogleOauth.Strategy(options, /*#__PURE__*/function () {
    var _ref = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, accessToken, refreshToken, profile, done) {
...
_passport.default.deserializeUser( /*#__PURE__*/function () {
  var _ref2 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(id, done) {
    var user;
